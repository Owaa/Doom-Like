...
HEADERS = GL4D/aes.h GL4D/gl4du.h GL4D/gl4dummies.h GL4D/gl4wdummies.h GL4D/gl4dm.h GL4D/bin_tree.h laby.h
SOURCES = window.c GL4D/aes.c GL4D/gl4du.c GL4D/gl4dummies.c GL4D/gl4dm.c GL4D/bin_tree.c cam.c laby.c
OBJ = $(SOURCES:.c=.o)
